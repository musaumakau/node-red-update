...
`);
    ...
    function HTTPRequest(n) {
        ...
        this.on("input",function(msg,nodeSend,nodeDone) {
            ...
            //getCert: add empty array if not exists
            if (msg.peerCertificates === undefined) {
            ...
            //getCert: for reliably retrieving the peer certificate, we must ensure using a separate agent with keepAlive=false
    ...
    RED.nodes.registerType("https-node",HTTPRequest,{
        credentials: {
            user: {type:"text"},
